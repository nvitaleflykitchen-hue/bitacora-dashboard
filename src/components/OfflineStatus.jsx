...
export default function OfflineStatus(){
  ...
  return <div role="status" aria-live="polite" style={{position:'fixed',right:14,bottom:76,zIndex:10000,display:'flex',alignItems:'center',gap:8,padding:'8px 11px',border:`1px solid ${online?'rgba(57,255,20,.4)':'rgba(255,170,0,.65)'}`,background:'rgba(10,10,14,.94)',color:online?'#39ff14':'#ffaa00',fontSize:11,fontFamily:'monospace',boxShadow:'0 8px 28px rgba(0,0,0,.35)'}}>

...
export const RELEASES = [
  {version:"2.9.14",date:"2026-09-07",title:"Completar datos de artículos",functions:["Propuestas para campos vacíos con fuente visible, sin reemplazar correcciones.","Interpretación de contenidos como 1 kg y cajas de 192 unidades de 8 g.","Consulta de fichas de Precialo con verificación del código exacto y enlace opcional."],problem:"Los artículos tenían campos vacíos aunque existía información en sus fuentes y algunos códigos no estaban en Open Facts.",affectedUsers:"Usuarios del maestro de artículos.",usage:"Abrí una ficha y pulsá Completar datos faltantes. Revisá las propuestas, aplicalas y guardá. Para otra ficha de Precialo podés pegar su enlace.",examples:["Completar el contenido del azúcar Dulcy y consultar la presentación de mayonesa Dánica de 192 unidades."],screenshots:[]},
  {version:"2.9.13",date:"2026-09-07",title:"Relevamiento y maestro de artículos",functions:["Lectura de códigos por cámara e ingreso manual desde el celular.","Búsqueda local y consulta a Open Food Facts, Open Products Facts y Open Beauty Facts.","Ficha editable, imagen, procedencia y presentaciones por unidad o caja; guardado y siguiente escaneo."],problem:"La aplicación no contaba con un maestro propio de productos identificados por código de barras.",affectedUsers:"Administración, responsables de grupo, encargados y usuarios de sede; consultores en lectura.",usage:"Ingresá a Artículos en escritorio o a Más → Relevamiento de artículos en el celular. Revisá el resultado, completá la presentación y guardá.",examples:["Registrar una caja de 192 sobres de 8 g sin confundirla con una unidad."],screenshots:[]},
  {version:"2.9.12",date:"2026-09-07",title:"Informe de sede y bienes concesionados",functions:["Previsualización del informe, elección de período y descarga del mismo PDF.","Indicadores de carga, documentación, evaluaciones, activos, flota, CAPA y mantenimiento.","Clasificación Sí / No / Sin definir para bienes concesionados, entidad y contrato, con filtro e informe."],problem:"El informe no distinguía faltantes y errores de consulta; los activos no identificaban su condición de concesionados.",affectedUsers:"Responsables de sedes, mantenimiento y flota.",usage:"En Ficha de unidad usá Ver informe. En la ficha del activo completá Titularidad del activo; disponible también en mantenimiento móvil.",examples:["Filtrar bienes concesionados y revisar el informe antes de descargar."],screenshots:[]},
